...
class SEBlock3D(nn.Module):
    ...
    def forward(self, x):
        ...
        return x * weights # Apply weights to the original feature map
...
#         # The attention block is initialized with the output channels of the conv layers
#         self.se_block = SEBlock3D(out_size)

#         # initialise the blocks
#         for m in self.children():
#             # Assuming you have an init_weights function defined
#             init_weights(m, init_type='kaiming')
...
#         # The features are re-weighted by the attention block before being returned
